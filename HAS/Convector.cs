...
namespace HAS
{
    class Convector : Heater
    {
        public Convector() { }
        public Convector(string manufacturer, string model, int service_area, int power, string power_suply, string placing,
        ...
        public Convector(string filestring) : base(filestring)
        {
